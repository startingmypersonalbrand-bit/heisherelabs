...
<img src="/images/about-profile.jpeg" alt="Habeeb Olanrewaju, Founder of Heishere Labs" className="aspect-[4/5] w-full rounded-[calc(var(--radius-xl)-6px)] object-cover" />
          </div>
